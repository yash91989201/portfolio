<!-- Capability: homepage. Scope: route `/` only — excludes database, API,
     authentication, form submission, and chat behavior; later capabilities
     replace the static content source without redefining page behavior. -->
